...
import { Shield, Mail, Globe, BookOpen, ArrowRight } from 'lucide-react'
        ...
        <section className="relative overflow-hidden border-b border-gray-800 bg-gray-900/40">
          ...
          <div className="relative max-w-4xl mx-auto px-6 pt-16 pb-14 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-900/50 border border-brand-700/50 text-brand-400 text-xs font-medium mb-6">
              ...
              6 Articles · Identity &amp; Transformation
            </div>
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
              A six-part series exploring identity clarity, the architecture of human transformation, and how CrestApp was built to bridge ancient wisdom with modern performance.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-8">
              {articles.map((a) => (
                ...
                >
                  {a.id}. {a.title.split(':')[0].split('—')[0].trim()}
                </a>
              ))}
            </div>
          </div>
